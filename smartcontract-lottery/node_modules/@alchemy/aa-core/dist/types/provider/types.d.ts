...
export type SmartAccountProviderOpts = z.input<typeof SmartAccountProviderOptsSchema>;
export type SmartAccountProviderConfig<TTransport extends SupportedTransports = Transport> = z.input<ReturnType<typeof createSmartAccountProviderConfigSchema<TTransport>>>;
