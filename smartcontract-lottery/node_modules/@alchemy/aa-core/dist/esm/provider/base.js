...
import { applyUserOpOverrideOrFeeOption, asyncPipe, bigIntMax, bigIntPercent, deepHexlify, defineReadOnly, filterUndefined, getDefaultEntryPointAddress, getDefaultUserOperationFeeOptions, getUserOperationHash, isValidRequest, resolveProperties, } from "../utils/index.js";
...
export class SmartAccountProvider extends EventEmitter {
    constructor(config_) {
        const config = createSmartAccountProviderConfigSchema().parse(config_);
