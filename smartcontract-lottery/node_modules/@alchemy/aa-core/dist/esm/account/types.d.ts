...
export type BaseSmartAccountParams<TTransport extends SupportedTransports = Transport> = z.input<ReturnType<typeof createBaseSmartAccountParamsSchema<TTransport>>>;
export type SimpleSmartAccountParams<TTransport extends SupportedTransports = Transport> = z.input<ReturnType<typeof SimpleSmartAccountParamsSchema<TTransport>>>;
