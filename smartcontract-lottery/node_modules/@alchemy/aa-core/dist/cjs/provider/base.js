...
class SmartAccountProvider extends eventemitter3_1.default {
    constructor(config_) {
        const config = (0, schema_js_1.createSmartAccountProviderConfigSchema)().parse(config_);
        ...
        Object.defineProperty(this, "gasEstimator", {
            ...
            value: async (struct, overrides, feeOptions) => {
                ...
                const callGasLimit = (0, index_js_1.applyUserOpOverrideOrFeeOption)(estimates.callGasLimit, overrides?.callGasLimit, feeOptions?.callGasLimit);
                const verificationGasLimit = (0, index_js_1.applyUserOpOverrideOrFeeOption)(estimates.verificationGasLimit, overrides?.verificationGasLimit, feeOptions?.verificationGasLimit);
                const preVerificationGas = (0, index_js_1.applyUserOpOverrideOrFeeOption)(estimates.preVerificationGas, overrides?.preVerificationGas, feeOptions?.preVerificationGas);
        ...
        Object.defineProperty(this, "feeDataGetter", {
            ...
            value: async (struct, overrides, feeOptions) => {
                ...
                let maxPriorityFeePerGas = await this.rpcClient.estimateMaxPriorityFeePerGas();
