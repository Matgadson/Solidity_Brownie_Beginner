...
__webpack_require__.d(__webpack_exports__, {
  ...
  GOERLI_CHAIN_ID: () => (/* reexport */ GOERLI_CHAIN_ID),
  ...
  POLYGON_MUMBAI_CHAIN_ID: () => (/* reexport */ POLYGON_MUMBAI_CHAIN_ID),
...
const TEST_CHAINS = [GOERLI_CHAIN_ID, SEPOLIA_CHAIN_ID];
const ETHERSCAN_SUPPORTED_CHAINS = [MAINNET_CHAIN_ID, GOERLI_CHAIN_ID, SEPOLIA_CHAIN_ID, BSC_MAINNET_CHAIN_ID, BSC_TESTNET_CHAIN_ID, OPTIMISM_MAINNET_CHAIN_ID, OPTIMISM_TESTNET_CHAIN_ID, AVALANCHE_MAINNET_CHAIN_ID, AVALANCHE_TESTNET_CHAIN_ID, ARBITRUM_MAINNET_CHAIN_ID, ARBITRUM_TESTNET_CHAIN_ID, POLYGON_CHAIN_ID, POLYGON_MUMBAI_CHAIN_ID, CELO_MAINNET_CHAIN_ID];
const SIMPLEHASH_SUPPORTED_CHAINS = [MAINNET_CHAIN_ID, POLYGON_CHAIN_ID, POLYGON_MUMBAI_CHAIN_ID, BSC_MAINNET_CHAIN_ID, BSC_TESTNET_CHAIN_ID, ARBITRUM_MAINNET_CHAIN_ID, ARBITRUM_TESTNET_CHAIN_ID, OPTIMISM_MAINNET_CHAIN_ID, OPTIMISM_TESTNET_CHAIN_ID, CELO_MAINNET_CHAIN_ID, AVALANCHE_MAINNET_CHAIN_ID, AVALANCHE_TESTNET_CHAIN_ID, GOERLI_CHAIN_ID];
...
class PreferencesController extends base_controllers_namespaceObject.BasePreferencesController {
  ...
  async calculatePastTx(txs, address) {
    ...
    for (const x of txs) {
      if (x.network === SUPPORTED_NETWORKS[this.getProviderConfig().chainId].chainId && x.to && x.from && (lowerCaseSelectedAddress === x.from.toLowerCase() || lowerCaseSelectedAddress === x.to.toLowerCase())) {
...
class TokenHandler {
  constructor(_ref) {
    ...
    this.contract = new external_ethers_namespaceObject.Contract(address, ecr20Abi, provider);
    this.symbol = symbol;
...
const erc20Interface = new external_ethers_namespaceObject.Interface(ecr20Abi);
