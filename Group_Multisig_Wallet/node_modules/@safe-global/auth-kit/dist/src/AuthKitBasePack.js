...
class AuthKitBasePack {
    ...
    async getSafes(txServiceUrl) {
        try {
            const apiKit = await __classPrivateFieldGet(this, _AuthKitBasePack_instances, "m", _AuthKitBasePack_getApiKit).call(this, txServiceUrl);
...
_AuthKitBasePack_instances = new WeakSet(), _AuthKitBasePack_getApiKit = 
/**
