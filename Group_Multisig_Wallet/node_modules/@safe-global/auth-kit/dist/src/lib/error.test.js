...
describe('errors', () => {
    describe('getErrorMessage()', () => {
        ...
        it('should return the message if it is an error with a message', () => {
            expect((0, errors_1.getErrorMessage)({ message: 'object with error message' })).toBe('object with error message');
        });
        it('should return the stringified error if it is any object', () => {
            expect((0, errors_1.getErrorMessage)({ anError: 'object with error message' })).toBe('{"anError":"object with error message"}');
        });
